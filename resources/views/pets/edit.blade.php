    ...
    <form action="/pets/update/{{ $pet->id }}" method="POST">
        ...
        <div class="row" id="">
            <div class="form-group col-lg-2">
                ...
                <input type="text" class="form-control" id="pet_name" name="pet_name" placeholder="Insira o nome" value="{{ $pet->pet_name }}">
            </div>
            <div class="form-group col-lg-2">
                <label for="species">Espécie</label>
                <input type="text" class="form-control" id="species" name="species" placeholder="Insira a espécie"  value="{{ $pet->species }}">
            </div>

            <div class="form-group col-lg-3">
                <label for="breed">Raça/SRD</label>
                <input type="text" class="form-control" id="breed" name="breed" placeholder="Insira a raça/SRD"  value="{{ $pet->breed }}">
            </div>
        ...
        <div class="row" id="">           
            <div class="form-group col-lg-12">
                ...
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="observations">{{ $pet->observations }}</textarea>
